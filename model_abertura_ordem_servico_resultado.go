...
// AberturaOrdemServicoResultado struct for AberturaOrdemServicoResultado
type AberturaOrdemServicoResultado struct {
	Ok *bool `json:"ok,omitempty"`
	Message NullableString `json:"message,omitempty"`
	Value *AberturaOrdemServico `json:"value,omitempty"`
}
...
func NewAberturaOrdemServicoResultado() *AberturaOrdemServicoResultado {
	this := AberturaOrdemServicoResultado{}
	return &this
}
...
func (o *AberturaOrdemServicoResultado) SetMessageNil() {
	o.Message.Set(nil)
}
...
// SetValue gets a reference to the given AberturaOrdemServico and assigns it to the Value field.
func (o *AberturaOrdemServicoResultado) SetValue(v AberturaOrdemServico) {
	o.Value = &v
}

func (o AberturaOrdemServicoResultado) MarshalJSON() ([]byte, error) {
...
type NullableAberturaOrdemServicoResultado struct {
	value *AberturaOrdemServicoResultado
	isSet bool
}

func (v NullableAberturaOrdemServicoResultado) Get() *AberturaOrdemServicoResultado {
	return v.value
}

func (v *NullableAberturaOrdemServicoResultado) Set(val *AberturaOrdemServicoResultado) {
	v.value = val
	v.isSet = true
}

func (v NullableAberturaOrdemServicoResultado) IsSet() bool {
	return v.isSet
}

func (v *NullableAberturaOrdemServicoResultado) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAberturaOrdemServicoResultado(val *AberturaOrdemServicoResultado) *NullableAberturaOrdemServicoResultado {
	return &NullableAberturaOrdemServicoResultado{value: val, isSet: true}
}

func (v NullableAberturaOrdemServicoResultado) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAberturaOrdemServicoResultado) UnmarshalJSON(src []byte) error {
	v.isSet = true
