...
// LocalDTOListResultado struct for LocalDTOListResultado
type LocalDTOListResultado struct {
	Ok *bool `json:"ok,omitempty"`
	Message NullableString `json:"message,omitempty"`
	Value []LocalDTO `json:"value,omitempty"`
}
...
func (o *LocalDTOListResultado) SetMessageNil() {
	o.Message.Set(nil)
}
...
// SetValue gets a reference to the given []LocalDTO and assigns it to the Value field.
func (o *LocalDTOListResultado) SetValue(v []LocalDTO) {
	o.Value = v
}

func (o LocalDTOListResultado) MarshalJSON() ([]byte, error) {
...
type NullableLocalDTOListResultado struct {
	value *LocalDTOListResultado
	isSet bool
}

func (v NullableLocalDTOListResultado) Get() *LocalDTOListResultado {
	return v.value
}

func (v *NullableLocalDTOListResultado) Set(val *LocalDTOListResultado) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalDTOListResultado) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalDTOListResultado) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalDTOListResultado(val *LocalDTOListResultado) *NullableLocalDTOListResultado {
	return &NullableLocalDTOListResultado{value: val, isSet: true}
}

func (v NullableLocalDTOListResultado) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalDTOListResultado) UnmarshalJSON(src []byte) error {
	v.isSet = true
