...
// ProdutoDTO struct for ProdutoDTO
...
func (o *ProdutoDTO) SetRefEntidadeNil() {
...
func (o *ProdutoDTO) SetDescricaoNil() {
	o.Descricao.Set(nil)
}
...
func (o *ProdutoDTO) SetRefImagemNil() {
	o.RefImagem.Set(nil)
}
...
func (o *ProdutoDTO) SetPresoTotalNil() {
...
func (o *ProdutoDTO) SetPesoLiquidoNil() {
...
func (o *ProdutoDTO) SetDimensoesNil() {
	o.Dimensoes.Set(nil)
}
...
func (o ProdutoDTO) MarshalJSON() ([]byte, error) {
...
type NullableProdutoDTO struct {
	value *ProdutoDTO
	isSet bool
}

func (v NullableProdutoDTO) Get() *ProdutoDTO {
	return v.value
}

func (v *NullableProdutoDTO) Set(val *ProdutoDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableProdutoDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableProdutoDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProdutoDTO(val *ProdutoDTO) *NullableProdutoDTO {
	return &NullableProdutoDTO{value: val, isSet: true}
}

func (v NullableProdutoDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProdutoDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
